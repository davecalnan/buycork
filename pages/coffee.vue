<template>
  <main>
    <hero
      bg-image="https://media.graphcms.com/resize=w:1920,h:640,f:crop/compress/1jwqNpLjQNOnlsrteurj"
      title="Cork's best coffee spots."
    />
      ...
      <section class="p-4">
        <hero-box class="shadow-lg rounded">
          <h1 for="search" class="mt-2 md:mt-4 mb-4 md:mb-6 text-2xl md:text-3xl font-normal">
            Find your new favouite local coffee.
          </h1>
...
export default {
  ...
  head() {
    return {
      title: 'Best local coffee spots | BuyCork.ie',
      meta: [
        { hid: 'description', name: 'description', content: '100% Local. 100% Indepenent. 100% Cork. Find your new favourite spot for coffee on BuyCork.ie.' },
        { property: 'og:type', content: 'website' },
        { property: 'og:url', content: 'https://buycork.ie/coffee' },
        { property: 'og:title', content: 'Best local coffee spots | BuyCork.ie' },
        { property: 'og:description', content: '100% Local. 100% Indepenent. 100% Cork. Find your new favourite spot for coffee on BuyCork.ie.' },
        { property: 'og:image', content: 'https://buycork.ie/img/coffee.jpg' },
        { property: 'twitter:card', content: 'summary_large_image' },
        { property: 'twitter:url', content: 'https://buycork.ie/coffee' },
        { property: 'twitter:title', content: 'Best local coffee spots | BuyCork.ie' },
        { property: 'twitter:description', content: '100% Local. 100% Indepenent. 100% Cork. Find your new favourite spot for coffee on BuyCork.ie.' },
        { property: 'twitter:image', content: 'https://buycork.ie/img/coffee.jpg' }
      ]
    }
  }
}
